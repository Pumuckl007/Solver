...
["", "solver.dart", , A, {
  ...
  solveIt: [function($event) {
    ...
    t1 = H.Primitives_parseDouble(J.get$value$x($.f), null);
    $.F = t1;
    t1 = J.$sub$n(J.$mul$ns($.A, t1), J.$mul$ns($.D, $.C));
    t2 = J.$sub$n(J.$mul$ns($.A, $.E), J.$mul$ns($.D, $.B));
    if (typeof t1 !== "number")
      return t1.$div();
    if (typeof t2 !== "number")
      return H.iae(t2);
    y = t1 / t2;
    t2 = J.$sub$n(J.$mul$ns($.B, y), $.C);
    t1 = J.$negate$n($.A);
    if (typeof t2 !== "number")
      return t2.$div();
    if (typeof t1 !== "number")
      return H.iae(t1);
    document.querySelector("#answer").textContent = "x = " + C.JSNumber_methods.toString$0(t2 / t1) + ", y = " + C.JSNumber_methods.toString$0(y);
